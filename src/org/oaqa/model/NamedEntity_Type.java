...
public class NamedEntity_Type extends OAQAAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.NamedEntity");
  ...
  public int getIds(int addr) {
      ...
      jcas.throwFeatMissing("ids", "org.oaqa.model.NamedEntity");
  ...
  public int getContext(int addr) {
      ...
      jcas.throwFeatMissing("context", "org.oaqa.model.NamedEntity");
