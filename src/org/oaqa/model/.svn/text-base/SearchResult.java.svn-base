...
public class SearchResult extends OAQATop {
  ...
  /** getter for offset - gets The offset in the containing file of the text associated with this search result.
   * @generated */
  public int getOffset() {
    if (SearchResult_Type.featOkTst && ((SearchResult_Type)jcasType).casFeat_offset == null)
      jcasType.jcas.throwFeatMissing("offset", "org.oaqa.model.SearchResult");
    return jcasType.ll_cas.ll_getIntValue(addr, ((SearchResult_Type)jcasType).casFeatCode_offset);}
    
  /** setter for offset - sets The offset in the containing file of the text associated with this search result. 
   * @generated */
  public void setOffset(int v) {
    if (SearchResult_Type.featOkTst && ((SearchResult_Type)jcasType).casFeat_offset == null)
      jcasType.jcas.throwFeatMissing("offset", "org.oaqa.model.SearchResult");
    jcasType.ll_cas.ll_setIntValue(addr, ((SearchResult_Type)jcasType).casFeatCode_offset, v);}    
   
    
  //*--------------*
  //* Feature: length

  /** getter for length - gets The length of the text in the source file associated with this search result.
   * @generated */
  public int getLength() {
    if (SearchResult_Type.featOkTst && ((SearchResult_Type)jcasType).casFeat_length == null)
      jcasType.jcas.throwFeatMissing("length", "org.oaqa.model.SearchResult");
    return jcasType.ll_cas.ll_getIntValue(addr, ((SearchResult_Type)jcasType).casFeatCode_length);}
    
  /** setter for length - sets The length of the text in the source file associated with this search result. 
   * @generated */
  public void setLength(int v) {
    if (SearchResult_Type.featOkTst && ((SearchResult_Type)jcasType).casFeat_length == null)
      jcasType.jcas.throwFeatMissing("length", "org.oaqa.model.SearchResult");
    jcasType.ll_cas.ll_setIntValue(addr, ((SearchResult_Type)jcasType).casFeatCode_length, v);}    
