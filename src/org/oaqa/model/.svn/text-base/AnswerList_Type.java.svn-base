...
public class AnswerList_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.AnswerList");
  ...
  public int getAnswerList(int addr) {
      ...
      jcas.throwFeatMissing("answerList", "org.oaqa.model.AnswerList");
  ...
  public boolean getNilAnswer(int addr) {
      ...
      jcas.throwFeatMissing("nilAnswer", "org.oaqa.model.AnswerList");
  ...
  public int getFeatureLabels(int addr) {
      ...
      jcas.throwFeatMissing("featureLabels", "org.oaqa.model.AnswerList");
